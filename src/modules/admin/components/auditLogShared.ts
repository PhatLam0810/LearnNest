...
export const ACTION_LABEL: Record<string, string> = {
  ...
  'admin.practiceClass.create': 'Tạo lớp thực hành',
  'admin.email.remindClassAssignment': 'Nhắc lớp thực hành nộp bài',
  'practiceTask.regradeAll': 'Chấm lại toàn bộ bài nộp',
  'practiceSubmission.override': 'Chấm điểm thủ công bài nộp',
  'practiceSubmission.regrade': 'Chấm lại bài nộp',
